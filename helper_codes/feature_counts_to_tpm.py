...
directory_path = r'C:\Users\GURDARSH VIRK\OneDrive\Desktop\PS 3-1 FloraBERT\FloraBERT_feature_counts\datasets'
...
for i, file_set in enumerate(file_sets):
    ...
    if set_match:
        ...
        tpm_output_file = os.path.join(r"C:\Users\GURDARSH VIRK\OneDrive\Desktop\PS 3-1 FloraBERT\FloraBERT_feature_counts\tpm_data", f"tpm_{set_number}.tabular")
