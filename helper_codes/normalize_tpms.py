...
input_dir = r'C:\Users\GURDARSH VIRK\OneDrive\Desktop\PS 3-1 FloraBERT\FloraBERT_feature_counts\tpm_data'  # Replace with the actual directory path

# Directory where the output files will be saved
output_dir = r'C:\Users\GURDARSH VIRK\OneDrive\Desktop\PS 3-1 FloraBERT\FloraBERT_feature_counts\normalized_tpm_data'  # Replace with the desired output directory path

# List all files in the input directory that start with 'tpm_' and end with '.tabular'
input_files = [filename for filename in os.listdir(input_dir) if filename.startswith('tpm_') and filename.endswith('.tabular')]
